...
// Crear instancia del cliente Resend con la API Key configurada en las variables de entorno
const resend = new Resend(process.env.RESEND_API_KEY);

// URL base del dominio de la aplicación, extraída de las variables de entorno
const domain = process.env.NEXT_PUBLIC_APP_URL;

// Enviar correo con el token de autenticación de dos factores
        ...
        <body>
          <table align="center" style="border-width:1px; border-style:solid; border-color:#eaeaea; border-radius:5px; margin-top:40px; max-width:465px; padding:20px;">
            <tbody>
              <tr>
                <td>
                  <img src="https://i.imgur.com/1QXLsFM.png" alt="Logo" height="130" style="display:block;margin:0 auto;">
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <p style="font-size:14px;">Para asegurarnos de que esta cuenta es realmente tuya, haz clic en el siguiente botón para confirmar tu dirección de correo electrónico.</p>
